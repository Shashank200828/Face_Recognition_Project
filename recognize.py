...
print("CWD:", os.getcwd())
print("data/faces contents:", os.listdir(data_path))
...
# Threshold for known/unknown faces
THRESHOLD = 70
...
while True:
    ...
    for (x, y, w, h) in faces_detected:
        ...
        print(f"DEBUG: user_id={user_id}, confidence={confidence}, marked_today={marked_today}")
